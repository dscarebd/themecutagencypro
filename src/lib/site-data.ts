import heroImageUrl from "../assets/cut-agency-hero.jpg";
import portraitsImageUrl from "../assets/cut-agency-portraits.jpg";
import teamImageUrl from "../assets/cut-agency-team.jpg";
...
export const heroImage = heroImageUrl;
export const teamImage = teamImageUrl;
export const portraitsImage = portraitsImageUrl;

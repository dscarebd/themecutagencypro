...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    { title: "Cut Agency — Playful CapCut-Inspired Creative Studio" },
    { name: "description", content: "Cut Agency is an international video editing, social media, and brand design studio for scroll-stopping campaigns." },
    { property: "og:title", content: "Cut Agency — Playful CapCut-Inspired Creative Studio" },
  ...
  return (
    <>
      <section className="relative min-h-[82vh] overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
          <div className="animate-fade-in pt-8">
            ...
            <h1 className="mt-6 max-w-4xl font-display text-6xl font-black leading-[.92] text-foreground sm:text-8xl">Cut Agency</h1>
          ...
          <div className="relative">
            <img src={teamImage} alt="Cut Agency creative team" className="floating-edit aspect-[4/3] w-full rounded-[2rem] border-4 border-card object-cover shadow-2xl" width={1344} height={768} />
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-4 py-20 sm:px-6 md:grid-cols-2 lg:px-8">
        <QuoteCard text="Cut Agency gave our content an instantly recognizable rhythm and look." author="Nora Blake, SaaS founder" />

...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Theme Cut Agency creates playful video editing, social media, and brand design for international teams." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Theme Cut Agency — Playful Video & Social Studio" },
      { name: "twitter:description", content: "Theme Cut Agency creates playful video editing, social media, and brand design for international teams." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a10028ff-c117-4d70-9a90-b3a90968c571" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a10028ff-c117-4d70-9a90-b3a90968c571" },
    ],

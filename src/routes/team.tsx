...
export const Route = createFileRoute("/team")({
  ...
  head: () => ({ meta: [
    { title: "Team — Cut Agency" },
    { name: "description", content: "Meet Cut Agency video editors, social strategists, and brand designers." },
    { property: "og:title", content: "Team — Cut Agency" },
    { property: "og:description", content: "Meet the colorful creative team behind Cut Agency." },
